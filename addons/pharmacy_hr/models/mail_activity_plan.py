...
class MailActivityPlan(models.Model):
    ...
    department_id = fields.Many2one(
        'pharmacy_hr.department', check_company=True,
    ...
    def _check_compatibility_with_model(self):
        ...
        plan_tocheck = self.filtered(lambda plan: plan.res_model != 'pharmacy_hr.employee')
    ...
    def _compute_department_id(self):
        for plan in self.filtered(lambda plan: plan.res_model != 'pharmacy_hr.employee'):
