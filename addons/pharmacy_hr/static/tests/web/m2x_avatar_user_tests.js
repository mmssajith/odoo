...
import { patchAvatarCardPopover } from "@pharmacy_hr/components/avatar_card/avatar_card_popover_patch";
...
QUnit.module("M2XAvatarUser", ({ beforeEach }) => {
    ...
    QUnit.test("avatar card preview with pharmacy_hr", async (assert) => {
        const pyEnv = await startServer();
        const departmentId = pyEnv["pharmacy_hr.department"].create({
            name: "Managemment"
        });
